...

            {
                role === ROLE.WHOLESALE ? (
                    <>
                        ...
                        <TextUnderTitle variant={'text-content__order-info'}>
                        В случае необходимости отмены товара (ов) в заказе и возрата денег на баланс, нажмите кнопку "ОТМЕНИТЬ" рядом с товаром. Если эта кнопка отсутствует, значит при отмене данного товара сумма заказа станет менее 5000 PLN, что является нарушением условий для категории Опт. В этой ситуации необходимо сначала добавить в заказ другие товары , а затем отменить те, которые более не нуждаются в выкупе, соблюдая правило общей суммы заказа.
                        </TextUnderTitle>
                    </>
                ) : null
            }
