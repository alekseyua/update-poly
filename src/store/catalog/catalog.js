...
export const catalog = store => {
    ...
    store.on('changeParamsFilters', ({ context }, obj, { dispatch }) => {
        try {
            const newContext = {
                ...context,
                "init_state": {
            ...
            console.log('ERROR changeParamsFilters', err)
        }
    })

    store.on('changeParamsFiltersPhoto', ({ context }, obj, { dispatch }) => {
        try {
            const newContext = {
                ...context,
                "init_state": {
            ...
            console.log('ERROR changeParamsFiltersPhoto', err);
        }
    })
    ...
    store.on('selectPhoto', ({ context }, obj, { dispatch }) => {
        try {
            ...
            console.log('ERROR selectPhoto', err)
        }
    })
    ...
    store.on('selectedAllPhoto', ({ context }, obj, { dispatch }) => {
        try {
            ...
            console.log('ERROR selectedAllPhoto', err)
        }
    })
